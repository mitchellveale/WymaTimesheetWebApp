                ...
                <div id="Data"> 
                    <div id="Form">
                        <div style="width: auto; height: auto;" >
                            ...
                            <asp:label runat="server" ID="NameLable" Font-Size="Larger"  CssClass="Text" Text="Name: "/>
                            <asp:DropDownList ID="NamePicker" runat="server" Font-Size="X-Large" CssClass="Text labels" width="250px" Height="75px" AutoPostBack="true" OnSelectedIndexChanged="TextChanged" ></asp:DropDownList>
                            
                            <asp:label runat="server" ID="DateLabel" CssClass="Text" Text="Date:" /> <!-- Date/Time -->
                            <asp:TextBox runat="server" TextMode="Date" ID="DateBox" Font-Size="X-Large" CssClass="Text labels" width="250px" Height="75px"  OnTextChanged="TextChanged" ></asp:TextBox>

                            <asp:label runat="server" ID="StartLabel" CssClass="Text" Text="Start Time:"/>
                            <asp:textbox runat="server" TextMode="Time" ID="TimeStartINP" Font-Size="X-Large"  CssClass="Text labels" width="250px" Height="75px"  OnTextChanged="TextChanged" /> <!-- Date/Time -->

                            <asp:label runat="server" ID="LunchTLabel" CssClass="Text" Text="Lunch Break Length:"/>
                            <asp:DropDownList ID="SelMin" runat="server" CssClass="Text labels" Font-Size="X-Large" width="250px" Height="75px"  OnSelectedIndexChanged="TextChanged" ></asp:DropDownList> 

                            <asp:label runat="server" ID="EndLabel" CssClass="Text" Text="End Time:"/>
                            <asp:textbox runat="server" TextMode="Time" ID="TimeEndINP" Font-Size="X-Large" CssClass="Text labels" width="250px" Height="75px"  OnTextChanged="TextChanged" /> <!-- Date/Time -->
